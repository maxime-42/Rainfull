...
I give printf the follow string `aaaaaa %x %x %x %x %x %x` the %x it telling to printf to print memory content<br/>
Buffer content `aaaaaa` is at the 4th position `61616161`.<br/>
